...
Shader "M_Normal"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = ( _Color0 * ( _Float0 * tex2D( _Albedo, uv_Albedo ) ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=17700
6.4;80;1524;605;1090.427;405.4114;1.47;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-326.0278,51.75862;Inherit;False;Property;_Float0;Float 0;3;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;3;-91.37012,-327.24;Inherit;False;Property;_Color0;Color 0;2;0;Create;True;0;0;False;0;1,0,0,0;1,0.4149246,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=D29485EB939C1AD8F06E328769B5D3F37E90FDE3